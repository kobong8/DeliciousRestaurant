# Generated by Django 5.0.6 on 2025-02-22 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(db_index=True, max_length=50, verbose_name="이름"),
                ),
                (
                    "category",
                    models.CharField(
                ...
                (
                    "rating_count",
                    models.PositiveIntegerField(null=True, verbose_name="별정 개수"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "keywords",
                    models.ManyToManyField(blank=True, to="restaurant.keyword"),
                ),
            ],
            options={
                "verbose_name": "가게",
